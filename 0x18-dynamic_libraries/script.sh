...
# Check the initial search directory and the destination directory are provided as the arguments
if [ $# -lt 3 ]; then
...
# Extract the destination directory from the second argument and handle the . and .. arguments
if [ "$2" = "." ]; then
